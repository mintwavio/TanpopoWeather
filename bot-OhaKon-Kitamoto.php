...
$image["SunMoon"]		= "https://linuxparadise.net/munin/localdomain/localhost.localdomain/kitamoto_sunmoon-week.png";
$image["MoonAge"]		= "https://linuxparadise.net/munin/localdomain/localhost.localdomain/kitamoto_moonage-week.png";
$image["MoonPhase"]		= "https://linuxparadise.net/munin/localdomain/localhost.localdomain/kitamoto_moonphase-week.png";
$image["OS"] 			= "http://linuxparadise.net/bot-Coffee-Image.php";
...
$SunMoon = $MM->StoreSunMoon("kitamoto_sunmoon_prefs.xml");
...
//-------------------------------------------------------------------------
		$update_params = array(
			'media_ids'    =>  $result_media_id["SunMoon"].",".$result_media_id["MoonAge"].",".$result_media_id["MoonPhase"].",".$result_media_id["OS"], //先ほど取得したmedia_id
