...
$www  = $TT->rekijitsu_3(1989,3,12,0,0,0);
...
//	$img = ImageCreateFromJPEG("/home/kouji/public_html/html/AutoTweet/image/363.jpg");
	$img = ImageCreateFromJPEG("/home/kouji/public_html/html/AutoTweet/image/lemon-mint2.jpg");
	...
	$www_days   = mb_convert_encoding("1989年03月12日 World Wide Webが生まれてから【".$www["days"]."】", 'UTF-8','auto');
	...
	ImageTTFText($img,  60, 0, 540+20, 250+$m, $white,$font, $nokori);
        ...
        ImageTTFText($img, 120, 0, 260+20+155, 410+$m, $green,$font_d, $nokori_day);
        ImageTTFText($img, 120, 0, 255+20+155, 405+$m, $white,$font_d, $nokori_day);
/*
	ImageTTFText($img, 120, 0, 260+20, 410+$m, $green,$font, $nokori_day);
	ImageTTFText($img, 120, 0, 255+20, 405+$m, $white,$font, $nokori_day);
*/
	ImageTTFText($img,  40, 0, 250+20, 495+$m, $cyan, $font, $Win7_days);
	ImageTTFText($img,  40, 0, 247+20, 492+$m, $white,$font, $Win7_days);

	ImageTTFText($img,  24, 0,  72+20, 570+$m, $blue,$font, $www_days.$www_daysx);
	ImageTTFText($img,  24, 0,  70+20, 568+$m, $white,$font, $www_days.$www_daysx);

	ImageTTFText($img,  24, 0,  78+20, 610+$m, $blue,$font, $hp_days.$hp_daysx);
	ImageTTFText($img,  24, 0,  76+20, 608+$m, $white,$font, $hp_days.$hp_daysx);
